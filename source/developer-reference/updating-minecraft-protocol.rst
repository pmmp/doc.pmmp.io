...
1. Get the appropriate palette mapping file that the BDS mod generated. You can find it in ``mapping_files/old_palette_mappings``, and the file name will be something like ``1.20.80.24_beta_to_current.bin``.
